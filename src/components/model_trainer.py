...
class ModelTrainer:
    ...
    def train_model(self, df):
        ...
        try:
            ...
            data = pd.read_csv(r'C:\Users\meetp\Downloads\!PYTHON FILES\MLops-Project\artifacts\marketing_cleaned.csv')
            cluster_df = pd.concat([data, pd.DataFrame({'Cluster': kmeans_labels})], axis=1)
            cluster_df.dropna(inplace=True)
            cluster_df.to_csv(r'C:\Users\meetp\Downloads\!PYTHON FILES\MLops-Project\artifacts\marketing_clustered.csv')
